...
<template>
  ...
  <div class="bg-Noir">
    ...
    <div class="flex justify-between px-4">
      ...
      <div class="px-[7%]">
        <h2 class="lg:pl-96 pt-10 font-made-okine-sans-personal-use font-regular text-Blanc sm:text-lg lg:text-xl xl:text-2xl">Une identité</h2>
        <h3 class="pt-20 font-made-okine-sans-personal-use font-light text-Blanc sm:text-base lg:text-base xl:text-base">Nous vous proposons une montre unique en son genre, de l’écran en passant par le bracelet et le boitier, faites de votre montre un bijou personnel inestimable.</h3>
        <h3 class="pt-20 font-made-okine-sans-personal-use font-light text-Blanc sm:text-base lg:text-base xl:text-base">Elaborer avec soin, avec des matériaux de qualité, telles que la céramique, en titane ou encore en acier, votre montre vous accompagnera partout à tout les instants.</h3>
      </div>
    </div>
