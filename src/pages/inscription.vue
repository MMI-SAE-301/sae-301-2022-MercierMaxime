<template>
    <div class="bg-Noir">
        ...
        <div class="flex justify-center">
            ...
            <FormKit label-class="text-Blanc" type="text" placeholder="Entrer votre nom" input-class="rounded-xl w-80 font-made-okine-sans-personal-use font-light sm:text-base lg:text-lg xl:text-xl" />
        </div>
    </div>
</template>